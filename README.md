...
When creating this file, please refer to the `simulation_config.yml` sample configuration file in the project directory. In case something breaks, make sure to keep a copy of it on your system.
